# Blockchain Simülasyonu Dokümantasyon Dizini

Bu dizin, projenin teknik dokümantasyonunu modüler bir yapıda sunar. Amaç, kavramsal çerçeve, mimari, çalışma ilkeleri, kullanım yönergeleri ve geliştirme notlarını ayrı belgelerde düzenli biçimde sunmaktır.

## Doküman Haritası

1. [Giriş ve Kapsam](01-giris-ve-kapsam.md)
2. [Sistem Mimarisi](02-sistem-mimarisi.md)
3. [İşlem ve UTXO Modeli](03-islem-ve-utxo-modeli.md)
4. [Mutabakat ve Güvenlik](04-mutabakat-ve-guvenlik.md)
...
Teknik inceleme sırasında aşağıdaki okuma sırası önerilir:

1. Kapsamı anlamak için **Giriş ve Kapsam**
2. Bileşenleri anlamak için **Sistem Mimarisi**
